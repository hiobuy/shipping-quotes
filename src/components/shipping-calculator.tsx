...
export function ShippingCalculator() {
  ...
  return <main>
    <header className="topbar"><a className="brand" href="/" aria-label="HIOBuy home"><span className="brand-mark">H</span><span>HIOBuy</span></a><span className="demo-pill">Developer demo</span><nav className="header-links" aria-label="Developer resources"><a className="docs-link" href="https://developers.hiobuy.com/" target="_blank" rel="noreferrer">Developer Console ↗</a><a className="docs-link" href="https://hiobuy.com/en/api-docs/fulfillment-freight-estimate" target="_blank" rel="noreferrer">API docs ↗</a><a className="docs-link" href="https://github.com/hiobuy/shipping-quotes" target="_blank" rel="noreferrer">GitHub ↗</a></nav></header>
